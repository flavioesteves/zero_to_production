        ...
        match subscriber {
            ...
            Err(error) => {
                tracing::warn!(
                    ...
                    "Skipping a confiermed subscriber. Their stored contact details are invalid."
                )
            }
        }
    }
...
CWOrkoo7oJBQ/iyh7uJ0LO2aLEfrHwTWllSAxT0zRno"
    ...
    spawn_blocking_with_tracing(move || {
        ...
        // and explicity executes all our computation
        // within its scope.
...
fn basic_authentication(headers: &HeaderMap) -> Result<Credentials, anyhow::Error> {
    ...
    let header_value = headers
        ...
        .to_str()
        .context("The authorization scheme was not a valid UTF8 string.")?;
    ...
    let decoded_credentials = String::from_utf8(decoded_credentials)
        .context("The decoded credential string is valid UTF.")?;
