...
impl Application {
    // We have converted the 'build' function into a contructor for `Application`
    ...
    // A more expressive name that makers it clear that
    // this function onlu returns when the application is stopped
